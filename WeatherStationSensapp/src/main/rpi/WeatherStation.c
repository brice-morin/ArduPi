...
void WeatherStation_send_sensapp_registerSensor(struct WeatherStation_Instance *_instance, char * name);
void WeatherStation_send_sensapp_pushData(struct WeatherStation_Instance *_instance, char * sensorID, char * key, int value);
#ifdef __cplusplus
}
#endif
...
{
WeatherStation_send_timer_timer_start(_instance, 30);
}
break;
default: break;
}
...
case WEATHERSTATION_SENSORSDISPLAYIMPL_INIT_STATE:
{
WeatherStation_send_sensapp_registerSensor(_instance, "thingml/weather/temp");
WeatherStation_send_sensapp_registerSensor(_instance, "thingml/weather/light");
...
WeatherStation_send_sensapp_pushData(_instance, "thingml/weather", "temp", temp);
}
}
}
}
...
WeatherStation_send_sensapp_pushData(_instance, "thingml/weather", "light", light);
}
}
}
}
...
void (*WeatherStation_send_sensapp_registerSensor_listener)(struct WeatherStation_Instance*, char *)= 0x0;
...
void WeatherStation_send_sensapp_registerSensor(struct WeatherStation_Instance *_instance, char * name){
if (WeatherStation_send_sensapp_registerSensor_listener != 0x0) WeatherStation_send_sensapp_registerSensor_listener(_instance, name);
}
void (*WeatherStation_send_sensapp_pushData_listener)(struct WeatherStation_Instance*, char *, char *, int)= 0x0;
...
void WeatherStation_send_sensapp_pushData(struct WeatherStation_Instance *_instance, char * sensorID, char * key, int value){
if (WeatherStation_send_sensapp_pushData_listener != 0x0) WeatherStation_send_sensapp_pushData_listener(_instance, sensorID, key, value);
}
