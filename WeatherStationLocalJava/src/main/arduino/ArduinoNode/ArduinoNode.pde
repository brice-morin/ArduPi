...
void SerialArduino_handle_Serial_print_value(struct SerialArduino_Instance *_instance, int16_t v);
// Declaration of callbacks for incomming messages:
...
void f_MessageSerializer_send(struct MessageSerializer_Instance *_instance) {
{
MessageSerializer_send_network_write_byte(_instance, _instance->PacketManager_START_BYTE_var);
...
MessageSerializer_send_network_write_byte(_instance, _instance->PacketManager_ESCAPE_BYTE_var);
}
MessageSerializer_send_network_write_byte(_instance, b);
i = i + 1;
}
MessageSerializer_send_network_write_byte(_instance, _instance->PacketManager_STOP_BYTE_var);
...
ArduinoNode_serializer_var.PacketManager_START_BYTE_var = 0x12;
ArduinoNode_serializer_var.PacketManager_STOP_BYTE_var = 0x13;
...
ArduinoNode_deserializer_var.PacketManager_START_BYTE_var = 0x12;
ArduinoNode_deserializer_var.PacketManager_STOP_BYTE_var = 0x13;
