...
uint8_t PacketManager_lengthInteger__var;
uint8_t PacketManager_lengthString__var;
uint8_t PacketManager_lengthUInt16__var;
int PacketManager_MAX_PACKET_SIZE__var;
uint8_t PacketManager_START_BYTE__var;
uint8_t PacketManager_STOP_BYTE__var;
uint8_t PacketManager_ESCAPE_BYTE__var;
long PacketManager_CODE_POSITION__var;
long PacketManager_LENGTH_POSITION__var;
long PacketManager_DATA_POSITION__var;
uint8_t PacketManager_buffer__var[16];
long PacketManager_index__var;
};
...
void register_MessageSerializer_send_network_write_byte_listener(void (*_listener)(struct MessageSerializer_Instance*, uint8_t));
...
void MessageSerializer_send_network_write_byte(struct MessageSerializer_Instance *_instance, uint8_t b);
...
void f_MessageSerializer_send(struct MessageSerializer_Instance *_instance) {
{
MessageSerializer_send_network_write_byte(_instance, _instance->PacketManager_START_BYTE__var);
int stop = _instance->PacketManager_DATA_POSITION__var + _instance->PacketManager_buffer__var[_instance->PacketManager_LENGTH_POSITION__var];
int i = 0;
while(i < stop) {
uint8_t b = _instance->PacketManager_buffer__var[i];
if(b == _instance->PacketManager_START_BYTE__var || b == _instance->PacketManager_STOP_BYTE__var || b == _instance->PacketManager_ESCAPE_BYTE__var) {
MessageSerializer_send_network_write_byte(_instance, _instance->PacketManager_ESCAPE_BYTE__var);
}
MessageSerializer_send_network_write_byte(_instance, b);
i = i + 1;
}
MessageSerializer_send_network_write_byte(_instance, _instance->PacketManager_STOP_BYTE__var);
_instance->PacketManager_index__var = 0;
}
}
...
f_MessageSerializer_storeByte(_instance, 0);
_instance->PacketManager_CODE_POSITION__var = _instance->PacketManager_index__var;
f_MessageSerializer_storeByte(_instance, code);
_instance->PacketManager_LENGTH_POSITION__var = _instance->PacketManager_index__var;
f_MessageSerializer_storeByte(_instance, length);
_instance->PacketManager_DATA_POSITION__var = _instance->PacketManager_index__var;
_instance->PacketManager_index__var = _instance->PacketManager_DATA_POSITION__var;
}
}
...
void f_MessageSerializer_storeByte(struct MessageSerializer_Instance *_instance, uint8_t b) {
{
if(_instance->PacketManager_index__var == _instance->PacketManager_MAX_PACKET_SIZE__var) {
// ERROR: ("BUFFER OVERFLOW: " + b + " has been ignored. Current index = " + _instance->PacketManager_index__var)
}
if(_instance->PacketManager_index__var < _instance->PacketManager_MAX_PACKET_SIZE__var) {
_instance->PacketManager_buffer__var[_instance->PacketManager_index__var] = b;
_instance->PacketManager_index__var = _instance->PacketManager_index__var + 1;
}
}
}
...
uint8_t b;
if(_instance->PacketManager_index__var < _instance->PacketManager_MAX_PACKET_SIZE__var) {
b = _instance->PacketManager_buffer__var[_instance->PacketManager_index__var];
_instance->PacketManager_index__var = _instance->PacketManager_index__var + 1;
}
if(_instance->PacketManager_index__var == _instance->PacketManager_MAX_PACKET_SIZE__var) {
// ERROR: ("BUFFER OVERFLOW: trying to read out of buffer boundaries")
b = _instance->PacketManager_STOP_BYTE__var;
}
return b;
}
}
...
void MessageSerializer_handle_RemoteControl_light(struct MessageSerializer_Instance *_instance, uint16_t light) {
uint8_t MessageSerializer_SerializerBehavior_State_event_consumed = 0;
if (_instance->MessageSerializer_SerializerBehavior_State == MESSAGESERIALIZER_SERIALIZERBEHAVIOR_SERIALIZE_STATE) {
if (MessageSerializer_SerializerBehavior_State_event_consumed == 0 && 1) {
{
f_MessageSerializer_setHeader(_instance, 11, _instance->PacketManager_lengthUInt16__var);
f_MessageSerializer_serializeUInt16(_instance, light);
f_MessageSerializer_send(_instance);
}
MessageSerializer_SerializerBehavior_State_event_consumed = 1;
}
}
}
void MessageSerializer_handle_RemoteControl_temperature(struct MessageSerializer_Instance *_instance, uint16_t temp) {
...
if (MessageSerializer_SerializerBehavior_State_event_consumed == 0 && 1) {
{
f_MessageSerializer_setHeader(_instance, 10, _instance->PacketManager_lengthUInt16__var);
...
void (*MessageSerializer_send_network_write_byte_listener)(struct MessageSerializer_Instance*, uint8_t)= 0x0;
void register_MessageSerializer_send_network_write_byte_listener(void (*_listener)(struct MessageSerializer_Instance*, uint8_t)){
MessageSerializer_send_network_write_byte_listener = _listener;
}
void MessageSerializer_send_network_write_byte(struct MessageSerializer_Instance *_instance, uint8_t b){
if (MessageSerializer_send_network_write_byte_listener != 0x0) MessageSerializer_send_network_write_byte_listener(_instance, b);
}
...
// Variables for the properties of the instance
int TemperatureSensor_temp__var;
};
...
void TemperatureSensor_handle_AnalogInput_analog_input_value(struct TemperatureSensor_Instance *_instance, int value);
// Declaration of callbacks for incomming messages:
void register_TemperatureSensor_send_TemperatureSensor_temperature_value_listener(void (*_listener)(struct TemperatureSensor_Instance*, int));
...
void TemperatureSensor_send_TemperatureSensor_temperature_value(struct TemperatureSensor_Instance *_instance, int val);
void TemperatureSensor_send_AnalogInput_read_analog_input(struct TemperatureSensor_Instance *_instance);
int f_TemperatureSensor_convertTemperature(struct TemperatureSensor_Instance *_instance, int adc);
#ifdef EXTERN_C_PROTOTYPES
}
#endif
...
// Event Handlers for incoming messages:
void TemperatureSensor_handle_TemperatureSensor_read_temperature(struct TemperatureSensor_Instance *_instance) {
uint8_t TemperatureSensor_TempSensorImpl_State_event_consumed = 0;
if (_instance->TemperatureSensor_TempSensorImpl_State == TEMPERATURESENSOR_TEMPSENSORIMPL_RUNNING_STATE) {
if (TemperatureSensor_TempSensorImpl_State_event_consumed == 0 && 1) {
...
TemperatureSensor_TempSensorImpl_State_event_consumed = 1;
}
}
}
void TemperatureSensor_handle_AnalogInput_analog_input_value(struct TemperatureSensor_Instance *_instance, int value) {
...
if (TemperatureSensor_TempSensorImpl_State_event_consumed == 0 && 1) {
{
TemperatureSensor_send_TemperatureSensor_temperature_value(_instance, (_instance->TemperatureSensor_temp__var + f_TemperatureSensor_convertTemperature(_instance, value)) / 2);
_instance->TemperatureSensor_temp__var = f_TemperatureSensor_convertTemperature(_instance, value);
}
TemperatureSensor_TempSensorImpl_State_event_consumed = 1;
}
}
...
// Observers for outgoing messages:
void (*TemperatureSensor_send_TemperatureSensor_temperature_value_listener)(struct TemperatureSensor_Instance*, int)= 0x0;
void register_TemperatureSensor_send_TemperatureSensor_temperature_value_listener(void (*_listener)(struct TemperatureSensor_Instance*, int)){
...
// Variables for the properties of the instance
uint8_t OnChangeAnalogInput_refresh_rate__var;
int OnChangeAnalogInput_OnChangeAnalogInputImpl_oldValue__var;
};

// Declaration of prototypes outgoing messages:
void OnChangeAnalogInput_OnChangeAnalogInputImpl_OnEntry(int state, struct OnChangeAnalogInput_Instance *_instance);
void OnChangeAnalogInput_handle_AnalogInput_analog_input_value(struct OnChangeAnalogInput_Instance *_instance, int value);
void OnChangeAnalogInput_handle_Timer_timer_timeout(struct OnChangeAnalogInput_Instance *_instance);
// Declaration of callbacks for incomming messages:
void register_OnChangeAnalogInput_send_OnChangeAnalogInput_analog_input_value_listener(void (*_listener)(struct OnChangeAnalogInput_Instance*, int));
...
void OnChangeAnalogInput_send_OnChangeAnalogInput_analog_input_value(struct OnChangeAnalogInput_Instance *_instance, int value);
...
OnChangeAnalogInput_send_Timer_timer_start(_instance, _instance->OnChangeAnalogInput_refresh_rate__var);
break;
...
// Observers for outgoing messages:
void (*OnChangeAnalogInput_send_OnChangeAnalogInput_analog_input_value_listener)(struct OnChangeAnalogInput_Instance*, int)= 0x0;
void register_OnChangeAnalogInput_send_OnChangeAnalogInput_analog_input_value_listener(void (*_listener)(struct OnChangeAnalogInput_Instance*, int)){
...
// Variables for the properties of the instance
uint8_t LcdScreen_maxDisplay__var;
uint8_t LcdScreen_maxLengthTitle__var;
uint8_t LcdScreen_maxLengthUnit__var;
int8_t LcdScreen_currentDisplay__var;
};
...
// Event Handlers for incoming messages:
void LcdScreen_handle_Display_initDisplay(struct LcdScreen_Instance *_instance, uint8_t id, char * title, char * unit, int initValue, int minValue, int maxValue) {
uint8_t LcdScreen_LcdScreenImp_State_event_consumed = 0;
if (_instance->LcdScreen_LcdScreenImp_State == LCDSCREEN_LCDSCREENIMP_RUNNING_STATE) {
if (LcdScreen_LcdScreenImp_State_event_consumed == 0 && 1) {
lcd_display_init (id, title, unit, initValue, minValue, maxValue);
LcdScreen_LcdScreenImp_State_event_consumed = 1;
}
}
}
void LcdScreen_handle_Display_setDisplay(struct LcdScreen_Instance *_instance, uint8_t id) {
...
_instance->LcdScreen_currentDisplay__var = id;
}
LcdScreen_LcdScreenImp_State_event_consumed = 1;
}
}
...
if(_instance->LcdScreen_currentDisplay__var == id) sensor_print_fullscreen (id);
}
LcdScreen_LcdScreenImp_State_event_consumed = 1;
}
}
...
// Event Handlers for incoming messages:
void Button_handle_DigitalInput_digital_input_value(struct Button_Instance *_instance, uint8_t value) {
uint8_t Button_ButtonImpl_State_event_consumed = 0;
if (_instance->Button_ButtonImpl_State == BUTTON_BUTTONIMPL_RUNNING_STATE) {
if (Button_ButtonImpl_State_event_consumed == 0 && value == DIGITALSTATE_HIGH) {
Button_send_Button_press(_instance);
Button_ButtonImpl_State_event_consumed = 1;
}
else if (Button_ButtonImpl_State_event_consumed == 0 && value == DIGITALSTATE_LOW) {
...
// Variables for the properties of the instance
uint8_t DigitalInputArduino_pin__var;
uint8_t DigitalInputArduino_pullup__var;
};
...
{
DigitalInputArduino_send_DigitalIO_pin_mode(_instance, _instance->DigitalInputArduino_pin__var, PINMODE_INPUT);
if(_instance->DigitalInputArduino_pullup__var) DigitalInputArduino_send_DigitalIO_digital_write(_instance, _instance->DigitalInputArduino_pin__var, DIGITALSTATE_HIGH);
}
...
// Event Handlers for incoming messages:
void DigitalInputArduino_handle_DigitalInput_read_digital_input(struct DigitalInputArduino_Instance *_instance) {
uint8_t DigitalInputArduino_SimpleDigitalInputImpl_State_event_consumed = 0;
if (_instance->DigitalInputArduino_SimpleDigitalInputImpl_State == DIGITALINPUTARDUINO_SIMPLEDIGITALINPUTIMPL_IDLE_STATE) {
if (DigitalInputArduino_SimpleDigitalInputImpl_State_event_consumed == 0 && 1) {
...
DigitalInputArduino_send_DigitalIO_digital_read(_instance, _instance->DigitalInputArduino_pin__var);
DigitalInputArduino_SimpleDigitalInputImpl_OnEntry(DIGITALINPUTARDUINO_SIMPLEDIGITALINPUTIMPL_WAITING_STATE, _instance);
DigitalInputArduino_SimpleDigitalInputImpl_State_event_consumed = 1;
}
}
}
void DigitalInputArduino_handle_DigitalIO_digital_read_result(struct DigitalInputArduino_Instance *_instance, uint8_t pin, uint8_t value) {
...
if (DigitalInputArduino_SimpleDigitalInputImpl_State_event_consumed == 0 && pin == _instance->DigitalInputArduino_pin__var) {
...
// Variables for the properties of the instance
uint8_t SensorsDisplay_tempDisplay__var;
uint8_t SensorsDisplay_lightDisplay__var;
uint16_t SensorsDisplay_temp__var;
uint16_t SensorsDisplay_light__var;
uint16_t SensorsDisplay_period__var;
};

// Declaration of prototypes outgoing messages:
void SensorsDisplay_SensorsDisplayImpl_OnEntry(int state, struct SensorsDisplay_Instance *_instance);
void SensorsDisplay_handle_TemperatureSensor_temperature_value(struct SensorsDisplay_Instance *_instance, int val);
...
{
SensorsDisplay_send_Display_initDisplay(_instance, _instance->SensorsDisplay_tempDisplay__var, "Temperature", "C", 25, 15, 40);
SensorsDisplay_send_Display_initDisplay(_instance, _instance->SensorsDisplay_lightDisplay__var, "Light", "", 0, 0, 1023);
}
...
{
SensorsDisplay_send_Display_setDisplay(_instance, _instance->SensorsDisplay_tempDisplay__var);
}
break;
case SENSORSDISPLAY_SENSORSDISPLAYIMPL_LIGHT_STATE:
{
SensorsDisplay_send_Display_setDisplay(_instance, _instance->SensorsDisplay_lightDisplay__var);
}
break;
default: break;
}
...
SensorsDisplay_send_RemoteControl_temperature(_instance, _instance->SensorsDisplay_temp__var);
SensorsDisplay_send_Led_led_toggle(_instance);
}
break;
case SENSORSDISPLAY_SENSORSDISPLAYIMPL_LIGHT_STATE:
{
SensorsDisplay_send_Led_led_toggle(_instance);
SensorsDisplay_send_RemoteControl_light(_instance, _instance->SensorsDisplay_light__var);
SensorsDisplay_send_Led_led_toggle(_instance);
}
break;
default: break;
...
// Event Handlers for incoming messages:
void SensorsDisplay_handle_TemperatureSensor_temperature_value(struct SensorsDisplay_Instance *_instance, int val) {
uint8_t SensorsDisplay_SensorsDisplayImpl_State_event_consumed = 0;
if (1) {
{
SensorsDisplay_send_Display_refreshDisplay(_instance, _instance->SensorsDisplay_tempDisplay__var, val);
_instance->SensorsDisplay_temp__var = val;
}
SensorsDisplay_SensorsDisplayImpl_State_event_consumed = 1;
}
}
void SensorsDisplay_handle_LightSensor_light_value(struct SensorsDisplay_Instance *_instance, uint16_t val) {
uint8_t SensorsDisplay_SensorsDisplayImpl_State_event_consumed = 0;
if (1) {
{
SensorsDisplay_send_Display_refreshDisplay(_instance, _instance->SensorsDisplay_lightDisplay__var, val);
_instance->SensorsDisplay_light__var = val;
}
SensorsDisplay_SensorsDisplayImpl_State_event_consumed = 1;
}
}
...
if (SensorsDisplay_SensorsDisplayImpl_State_event_consumed == 0 && 1) {
...
void SerialArduino_handle_IOStream_write_byte(struct SerialArduino_Instance *_instance, uint8_t b);
void SerialArduino_handle_Serial_print_message(struct SerialArduino_Instance *_instance, char * msg);
void SerialArduino_handle_Serial_print_value(struct SerialArduino_Instance *_instance, int v);
void SerialArduino_handle_Polling_poll(struct SerialArduino_Instance *_instance);
// Declaration of callbacks for incomming messages:
void register_SerialArduino_send_IOStream_receive_byte_listener(void (*_listener)(struct SerialArduino_Instance*, uint8_t));
...
void SerialArduino_send_IOStream_receive_byte(struct SerialArduino_Instance *_instance, uint8_t b);
#ifdef EXTERN_C_PROTOTYPES
}
#endif
...
// Event Handlers for incoming messages:
void SerialArduino_handle_IOStream_write_byte(struct SerialArduino_Instance *_instance, uint8_t b) {
uint8_t SerialArduino_SerialImpl_State_event_consumed = 0;
if (_instance->SerialArduino_SerialImpl_State == SERIALARDUINO_SERIALIMPL_RECEIVING_STATE) {
if (SerialArduino_SerialImpl_State_event_consumed == 0 && 1) {
Serial.print(b);
SerialArduino_SerialImpl_State_event_consumed = 1;
}
}
}
void SerialArduino_handle_Serial_print_message(struct SerialArduino_Instance *_instance, char * msg) {
...
uint8_t SerialArduino_SerialImpl_State_event_consumed = 0;
if (_instance->SerialArduino_SerialImpl_State == SERIALARDUINO_SERIALIMPL_RECEIVING_STATE) {
if (SerialArduino_SerialImpl_State_event_consumed == 0 && Serial.available() > 0) {
SerialArduino_send_IOStream_receive_byte(_instance, (char)Serial.read());
SerialArduino_SerialImpl_State_event_consumed = 1;
}
}
}
...
// Observers for outgoing messages:
void (*SerialArduino_send_IOStream_receive_byte_listener)(struct SerialArduino_Instance*, uint8_t)= 0x0;
void register_SerialArduino_send_IOStream_receive_byte_listener(void (*_listener)(struct SerialArduino_Instance*, uint8_t)){
SerialArduino_send_IOStream_receive_byte_listener = _listener;
}
void SerialArduino_send_IOStream_receive_byte(struct SerialArduino_Instance *_instance, uint8_t b){
if (SerialArduino_send_IOStream_receive_byte_listener != 0x0) SerialArduino_send_IOStream_receive_byte_listener(_instance, b);
}
...
void LightSensor_handle_AnalogInput_analog_input_value(struct LightSensor_Instance *_instance, int value);
...
// Event Handlers for incoming messages:
void LightSensor_handle_AnalogInput_analog_input_value(struct LightSensor_Instance *_instance, int value) {
uint8_t LightSensor_LightSensorImpl_State_event_consumed = 0;
if (1) {
LightSensor_send_LightSensor_light_value(_instance, value);
LightSensor_LightSensorImpl_State_event_consumed = 1;
}
}
void LightSensor_handle_LightSensor_read_light(struct LightSensor_Instance *_instance) {
uint8_t LightSensor_LightSensorImpl_State_event_consumed = 0;
if (_instance->LightSensor_LightSensorImpl_State == LIGHTSENSOR_LIGHTSENSORIMPL_RUNNING_STATE) {
if (LightSensor_LightSensorImpl_State_event_consumed == 0 && 1) {
...
void MessageDeserializer_handle_network_receive_byte(struct MessageDeserializer_Instance *_instance, uint8_t b);
// Declaration of callbacks for incomming messages:
...
{
_instance->PacketManager_index__var = _instance->PacketManager_DATA_POSITION__var;
uint8_t code = _instance->PacketManager_buffer__var[_instance->PacketManager_CODE_POSITION__var];
if(code == 20) {
...
// Event Handlers for incoming messages:
void MessageDeserializer_handle_network_receive_byte(struct MessageDeserializer_Instance *_instance, uint8_t b) {
uint8_t MessageDeserializer_receive_State_event_consumed = 0;
if (_instance->MessageDeserializer_receive_State == MESSAGEDESERIALIZER_RECEIVE_IDLE_STATE) {
if (MessageDeserializer_receive_State_event_consumed == 0 && b == _instance->PacketManager_START_BYTE__var) {
...
MessageDeserializer_receive_State_event_consumed = 1;
}
}
else if (_instance->MessageDeserializer_receive_State == MESSAGEDESERIALIZER_RECEIVE_RECEIVEMESSAGE_STATE) {
if (MessageDeserializer_receive_State_event_consumed == 0 && b == _instance->PacketManager_ESCAPE_BYTE__var) {
...
else if (MessageDeserializer_receive_State_event_consumed == 0 && b == _instance->PacketManager_STOP_BYTE__var) {
MessageDeserializer_receive_OnExit(MESSAGEDESERIALIZER_RECEIVE_RECEIVEMESSAGE_STATE, _instance);
_instance->MessageDeserializer_receive_State = MESSAGEDESERIALIZER_RECEIVE_IDLE_STATE;
...
else if (MessageDeserializer_receive_State_event_consumed == 0 &&  !(b == _instance->PacketManager_ESCAPE_BYTE__var || b == _instance->PacketManager_STOP_BYTE__var)) {
f_MessageDeserializer_storeByte(_instance, b);
MessageDeserializer_receive_State_event_consumed = 1;
}
else if (MessageDeserializer_receive_State_event_consumed == 0 && b == _instance->PacketManager_START_BYTE__var) {
_instance->PacketManager_index__var = 0;
MessageDeserializer_receive_State_event_consumed = 1;
}
}
else if (_instance->MessageDeserializer_receive_State == MESSAGEDESERIALIZER_RECEIVE_ESCAPE_STATE) {
if (MessageDeserializer_receive_State_event_consumed == 0 && 1) {
...
// Variables for the properties of the instance
uint8_t AnalogInputArduino_pin__var;
};
...
void AnalogInputArduino_handle_AnalogIO_analog_read_result(struct AnalogInputArduino_Instance *_instance, uint8_t pin, int value);
// Declaration of callbacks for incomming messages:
...
void register_AnalogInputArduino_send_AnalogInput_analog_input_value_listener(void (*_listener)(struct AnalogInputArduino_Instance*, int));
...
void AnalogInputArduino_send_AnalogInput_analog_input_value(struct AnalogInputArduino_Instance *_instance, int value);
#ifdef EXTERN_C_PROTOTYPES
}
#endif
...
// Event Handlers for incoming messages:
void AnalogInputArduino_handle_AnalogInput_read_analog_input(struct AnalogInputArduino_Instance *_instance) {
uint8_t AnalogInputArduino_SimpleAnalogInputImp_State_event_consumed = 0;
if (_instance->AnalogInputArduino_SimpleAnalogInputImp_State == ANALOGINPUTARDUINO_SIMPLEANALOGINPUTIMP_RUNNING_STATE) {
if (AnalogInputArduino_SimpleAnalogInputImp_State_event_consumed == 0 && 1) {
...
AnalogInputArduino_send_AnalogIO_analog_read(_instance, _instance->AnalogInputArduino_pin__var);
AnalogInputArduino_SimpleAnalogInputImp_OnEntry(ANALOGINPUTARDUINO_SIMPLEANALOGINPUTIMP_WAITING_STATE, _instance);
AnalogInputArduino_SimpleAnalogInputImp_State_event_consumed = 1;
}
}
}
void AnalogInputArduino_handle_AnalogIO_analog_read_result(struct AnalogInputArduino_Instance *_instance, uint8_t pin, int value) {
...
if (AnalogInputArduino_SimpleAnalogInputImp_State_event_consumed == 0 && pin == _instance->AnalogInputArduino_pin__var) {
...
void (*AnalogInputArduino_send_AnalogInput_analog_input_value_listener)(struct AnalogInputArduino_Instance*, int)= 0x0;
void register_AnalogInputArduino_send_AnalogInput_analog_input_value_listener(void (*_listener)(struct AnalogInputArduino_Instance*, int)){
...
// Event Handlers for incoming messages:
void OnChangeDigitalInput_handle_DigitalInput_digital_input_value(struct OnChangeDigitalInput_Instance *_instance, uint8_t value) {
uint8_t OnChangeDigitalInput_OnChangeDigitalInputImpl_State_event_consumed = 0;
if (_instance->OnChangeDigitalInput_OnChangeDigitalInputImpl_State == ONCHANGEDIGITALINPUT_ONCHANGEDIGITALINPUTIMPL_LOW_STATE) {
if (OnChangeDigitalInput_OnChangeDigitalInputImpl_State_event_consumed == 0 && value == DIGITALSTATE_HIGH) {
...
OnChangeDigitalInput_OnChangeDigitalInputImpl_State_event_consumed = 1;
}
}
...
if (OnChangeDigitalInput_OnChangeDigitalInputImpl_State_event_consumed == 0 && value == DIGITALSTATE_LOW) {
...
uint8_t OnChangeDigitalInput_OnChangeDigitalInputImpl_Polling_State_event_consumed = 0;
...
if (OnChangeDigitalInput_OnChangeDigitalInputImpl_Polling_State_event_consumed == 0 && 1) {
...
OnChangeDigitalInput_OnChangeDigitalInputImpl_Polling_State_event_consumed = 1;
}
}
}
void OnChangeDigitalInput_handle_Polling_poll(struct OnChangeDigitalInput_Instance *_instance) {
...
// Enqueue of messages MessageSerializer::network::write_byte
void enqueue_MessageSerializer_send_network_write_byte(struct MessageSerializer_Instance *_instance, uint8_t b){
...
void enqueue_AnalogInputArduino_send_AnalogInput_analog_input_value(struct AnalogInputArduino_Instance *_instance, int value){
if ( fifo_byte_available() > 6 ) {
...
void enqueue_ArduinoArduino_send_AnalogIO_analog_read_result(struct ArduinoArduino_Instance *_instance, uint8_t pin, int value){
...
void enqueue_TemperatureSensor_send_TemperatureSensor_temperature_value(struct TemperatureSensor_Instance *_instance, int val){
if ( fifo_byte_available() > 6 ) {
...
// Enqueue of messages SerialArduino::IOStream::receive_byte
void enqueue_SerialArduino_send_IOStream_receive_byte(struct SerialArduino_Instance *_instance, uint8_t b){
if ( fifo_byte_available() > 5 ) {
...
void dispatch_AnalogInputArduino_send_AnalogInput_analog_input_value(struct AnalogInputArduino_Instance *_instance, int value){
if (_instance == &ArduinoNode_temp_sensor_io_analog_input_var) {
...
void dispatch_ArduinoArduino_send_AnalogIO_analog_read_result(struct ArduinoArduino_Instance *_instance, uint8_t pin, int value){
...
void dispatch_TemperatureSensor_send_TemperatureSensor_temperature_value(struct TemperatureSensor_Instance *_instance, int val){
...
// Dispatch for messages SerialArduino::IOStream::receive_byte
void dispatch_SerialArduino_send_IOStream_receive_byte(struct SerialArduino_Instance *_instance, uint8_t b){
if (_instance == &network_var) {
MessageDeserializer_handle_network_receive_byte(&ArduinoNode_deserializer_var, b);
}
}
...
// Dispatch for messages MessageSerializer::network::write_byte
void dispatch_MessageSerializer_send_network_write_byte(struct MessageSerializer_Instance *_instance, uint8_t b){
if (_instance == &ArduinoNode_serializer_var) {
SerialArduino_handle_IOStream_write_byte(&network_var, b);
}
}
...
case 5:
while (mbufi < 3) mbuf[mbufi++] = fifo_dequeue();
dispatch_MessageSerializer_send_network_write_byte((struct MessageSerializer_Instance*)instance_by_id((mbuf[0] << 8) + mbuf[1]) /* instance */,
mbuf[2] /* b */ );
break;
case 23:
while (mbufi < 2) mbuf[mbufi++] = fifo_dequeue();
...
case 25:
while (mbufi < 3) mbuf[mbufi++] = fifo_dequeue();
dispatch_SerialArduino_send_IOStream_receive_byte((struct SerialArduino_Instance*)instance_by_id((mbuf[0] << 8) + mbuf[1]) /* instance */,
mbuf[2] /* b */ );
break;
case 10:
while (mbufi < 2) mbuf[mbufi++] = fifo_dequeue();
...
register_SerialArduino_send_IOStream_receive_byte_listener(enqueue_SerialArduino_send_IOStream_receive_byte);
...
register_MessageSerializer_send_network_write_byte_listener(enqueue_MessageSerializer_send_network_write_byte);
...
ArduinoNode_serializer_var.PacketManager_lengthInteger__var = 2;
ArduinoNode_serializer_var.PacketManager_lengthString__var = 8;
ArduinoNode_serializer_var.PacketManager_lengthUInt16__var = 2;
ArduinoNode_serializer_var.PacketManager_MAX_PACKET_SIZE__var = 16;
ArduinoNode_serializer_var.PacketManager_START_BYTE__var = 0x12;
ArduinoNode_serializer_var.PacketManager_STOP_BYTE__var = 0x13;
ArduinoNode_serializer_var.PacketManager_ESCAPE_BYTE__var = 0x7D;
ArduinoNode_serializer_var.PacketManager_CODE_POSITION__var = 3;
ArduinoNode_serializer_var.PacketManager_LENGTH_POSITION__var = 4;
ArduinoNode_serializer_var.PacketManager_DATA_POSITION__var = 5;
ArduinoNode_serializer_var.PacketManager_index__var = 0;
...
ArduinoNode_light_sensor_io_timer_var.TimerArduino_SoftTimer_target__var = 0;
...
ArduinoNode_app_var.SensorsDisplay_tempDisplay__var = 0;
ArduinoNode_app_var.SensorsDisplay_lightDisplay__var = 2;
ArduinoNode_app_var.SensorsDisplay_period__var = 2000;
...
ArduinoNode_deserializer_var.PacketManager_lengthInteger__var = 2;
ArduinoNode_deserializer_var.PacketManager_lengthString__var = 8;
ArduinoNode_deserializer_var.PacketManager_lengthUInt16__var = 2;
ArduinoNode_deserializer_var.PacketManager_MAX_PACKET_SIZE__var = 16;
ArduinoNode_deserializer_var.PacketManager_START_BYTE__var = 0x12;
ArduinoNode_deserializer_var.PacketManager_STOP_BYTE__var = 0x13;
ArduinoNode_deserializer_var.PacketManager_ESCAPE_BYTE__var = 0x7D;
ArduinoNode_deserializer_var.PacketManager_CODE_POSITION__var = 3;
ArduinoNode_deserializer_var.PacketManager_LENGTH_POSITION__var = 4;
ArduinoNode_deserializer_var.PacketManager_DATA_POSITION__var = 5;
ArduinoNode_deserializer_var.PacketManager_index__var = 0;
...
ArduinoNode_light_sensor_io_change_analog_input_var.OnChangeAnalogInput_refresh_rate__var = 500;
ArduinoNode_light_sensor_io_change_analog_input_var.OnChangeAnalogInput_OnChangeAnalogInputImpl_oldValue__var =  -1;
...
ArduinoNode_button_io_digital_input_var.DigitalInputArduino_pin__var = DIGITALPIN_PIN_8;
ArduinoNode_button_io_digital_input_var.DigitalInputArduino_pullup__var = 0;
...
ArduinoNode_led_io_digital_output_var.DigitalOutputArduino_pin__var = DIGITALPIN_PIN_9;
...
screen_var.LcdScreen_maxDisplay__var = 1;
screen_var.LcdScreen_maxLengthTitle__var = 10;
screen_var.LcdScreen_maxLengthUnit__var = 5;
screen_var.LcdScreen_currentDisplay__var =  -1;
...
ArduinoNode_temp_sensor_io_change_analog_input_var.OnChangeAnalogInput_refresh_rate__var = 500;
ArduinoNode_temp_sensor_io_change_analog_input_var.OnChangeAnalogInput_OnChangeAnalogInputImpl_oldValue__var =  -1;
...
ArduinoNode_temp_sensor_temperature_sensor_var.TemperatureSensor_temp__var = 0;
...
ArduinoNode_temp_sensor_io_timer_var.TimerArduino_SoftTimer_target__var = 0;
...
ArduinoNode_temp_sensor_io_analog_input_var.AnalogInputArduino_pin__var = ANALOGPIN_A_3;
...
ArduinoNode_light_sensor_io_analog_input_var.AnalogInputArduino_pin__var = ANALOGPIN_A_1;
