...
void WeatherStation_send_db_push_int(struct WeatherStation_Instance *_instance, char * db, char * sensor, int value);
#ifdef __cplusplus
}
#endif
...
WeatherStation_send_db_push_int(_instance, "thingml.weather", "temp", temp);
}
}
}
}
...
WeatherStation_send_db_push_int(_instance, "thingml.weather", "light", light);
}
}
}
}
...
void WeatherStation_send_db_push_int(struct WeatherStation_Instance *_instance, char * db, char * sensor, int value){
if (WeatherStation_send_db_push_int_listener != 0x0) WeatherStation_send_db_push_int_listener(_instance, db, sensor, value);
}
