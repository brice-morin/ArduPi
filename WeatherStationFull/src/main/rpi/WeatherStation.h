...
// Variables for the properties of the instance
        int WeatherStation_counter_var;
        int WeatherStation_delay_var;
        int WeatherStation_i_var;
    };
...
#define WEATHERSTATION_SENSORSDISPLAYIMPL_INITDB_STATE 2
#define WEATHERSTATION_SENSORSDISPLAYIMPL_PROCESS_STATE 3
